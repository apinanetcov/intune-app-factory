...
Connect-MgGraph -TenantID $TenantId -ClientSecretCredential (New-Object System.Management.Automation.PSCredential("$ClientId", (ConvertTo-SecureString "$ClientSecret" -AsPlainText -Force))) -NoWelcome
